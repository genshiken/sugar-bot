    ...
    public override registerApplicationCommands(registry: ChatInputCommand.Registry) {
        registry.registerChatInputCommand(
            (builder) => {
                builder
                    .setName("playlist")
                    .setDescription("Manage playlist with Sugar")
                    ...
                    .addSubcommand((subcommand) =>
                        subcommand
                            ...
                            .addStringOption((opt) =>
                                opt
                                    .setName("resourceid")
                                    .setDescription("Resource identifier to load. Can be playlist name stored on Sugar or Youtube Playlist ID")
                                    .setRequired(true)
                            )
                    );
            },
            {
                idHints: ["1194230718096736346"],
            }
        );
    }
